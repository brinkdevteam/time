...
// tslint:disable-next-line: object-literal-sort-keys
  ...
  async (token: string, tokenSecret: string, profile: any, cb: any) => {
...
gitlab.get('/gitlab/auth',
  passport.authorize('gitlab'),
);

gitlab.get('/gitlab/auth/callback',
  passport.authorize('gitlab', { failureRedirect: '/account' }),
  (req, res) => {
    // tslint:disable-next-line: no-console
